...
위의 코드는 ES6의 스펙인 default function parameter를 사용한 예입니다.<br>
...
듣기만 해도 복잡하고 어려울 것 같지만 변환과 압축을 한방에 해주는 도구들이 이미 많이 배포가 되어 있는 상황이기 때문에 설정 파일을 만들고 명령어를 실행만 하면 됩니다.<br>
