...
이번 단락에서는 ECMAScript2015 의 기능들에 대해서 알아 보도록 하겠습니다.
...
**var대신 let이라는 키워드** 를 사용하여 일반 자바나 c#처럼 블록 내 에서만 사용할 수 있는 변수 가 되며,
...
ES6 코드를 원본 그대로 실행시킬 수 있는 브라우저가 아직 없다는 이야기 입니다.<br>
