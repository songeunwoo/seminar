...
Iteration 관련 부록<br>
<br>
ES5에서 반복문 처리를 위한 몇가지 추가된 기능이 있습니다.<br>

- forEach : callBack 함수의 return 되는 값과 상관 없이 전체 반복문 수행
- every : callBack 함수의 return 되는 값이 false 면 멈춤
- some : callBack 함수의 return 되는 값이 true 면 멈춤
...
IE11 에서는 함수 중첩의 복잡함을 해소할 수 있는 Arrow function 스펙을 지원하지 않고 있습니다.<br>
...
한땀 한땀 직접 수정해 주시면 됩니다!!!<br>
<br><br><br><br><br><br><br><br><br><br>
라고 한다면 싫어 하실테니,<br>
babel 또는 traceur transpiler를 사용하면<br>
ES2015 코드들을 전부 ES5 코드로 변환해 사용 가능합니다.<br>
현재까지 출시된 모든 '모던' 브라우저에서 문제없이 동작이 가능합니다.<br>
...
이 문서 에서는 ES2015에 대해 기본적
새롭게 추가 되거나 변경 확장되어 알아두면 유용할 문법들이 많습니다. <br>
