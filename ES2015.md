...
> ECMAScript란 무엇인지 기본적인 개념과 문법, 사용 방법에 대해 알아 보겠습니다. <br>
...
그럼 어떤 기구인지 히스토리를 좀 보고 갈까요..?? 제가 사기꾼 일수도 있으니까용
...
이런 훌륭한 ECMAScript 기능이 있지만,<br>
주요 모던 브라우저들이 자바스크립트 엔진에서 이를 완벽히 지원하고 있지는 않다는 이야기 기억 하시나요?<br>
<br>
...
이번엔 새로운 문법을 활용한 예시를 통해 살펴보도록 하겠습니다.

```javascript

```
이런 비동기 프로그래밍에서 ES6의 promise - then문법을 이 글에서 소개하지는 않았지만 ES7에서는 async - await 라는<br>
리액티브 프로그래밍 문법을 지원합니다. 심지어 자바9에서도 리액티브 프로그래밍 방식을 지원할 예정이라 합니다.<br>
